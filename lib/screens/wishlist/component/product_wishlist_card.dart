  ...
  Widget build(BuildContext context) {
    return Consumer<CartProvider>(
      builder: (context, cartProvider, _) {
        ...
        final quantityNotifier = cartProvider.getQuantityNotifier(
            product.id,
            product.inCart
        );
                          ...
                          builder: (context, wishlistProvider, _) {
                            return Container(
                              ...
                              child: IconButton(
                                ...
                                onPressed: wishlistProvider.isProductLoading(product.id)
                                    ? null
                                    : () async {
                                  await wishlistProvider.removeFromWishlist(
                                      product.id, context);
                                  if (context.mounted) {
                                    wishlistProvider.deleteState.state.maybeWhen(
                                        success: (response) {
